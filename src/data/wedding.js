  ...
  travel: {
    ...
    hotels: [
      ...
      },
      {
        ...
        note: 'A la entrada de la ciudad por la avenida de Madrid.',
        code: 'XXX',
        url: '', bookingUrl: '', phone: '953 26 30 40', email: '',
      },
      {
        name: 'Hotel Condestable Iranzo',
        stars: 3,
        area: 'Paseo de la Estación, 32',
        note: 'En el paseo principal de la ciudad, a un paseo del centro.',
        code: 'XXX',
      ...
      },
      {
        ...
        note: 'En el centro de Jaén.',
        code: 'XXX',
        url: '', bookingUrl: '', phone: '953 22 27 00', email: '',
      },
    ],
    shuttle:
