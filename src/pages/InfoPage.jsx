...
/* De momento esta página es solo la cuenta. El dress code sigue en
   data/wedding.js por si vuelve, pero aquí no se pinta. */
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="mt-8 p-4" style={{ border: '1px solid var(--hairline)', width: 'min(100%, 340px)' }}>
